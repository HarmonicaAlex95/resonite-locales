...
if __name__ == "__main__":
    ...
    parser.add_argument('--add-missing-keys', metavar='add_missing_keys', type=str, 
                        help='If a key is missing in the translation, copy original text from en.json to the output file.')

    args = parser.parse_args()
    N = LocaleCleaner(args.en, args.lang, args.out, arg.add_missing_keys)
    N.run()
    print("Cleaned!")
